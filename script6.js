...
L.Control.Info = L.Control.extend({
    onAdd: function(map) {
        ...
        L.DomEvent.on(infoButton, 'click', function() {
            window.location.href = 'index6_info.html';
        });
        return infoButton;
    },
...
document.getElementById('yesButton').addEventListener('click', function() {
    storeResponse('yes', 6);  // 6 oznacza, że jest to odpowiedź na szóste pytanie
});

document.getElementById('noButton').addEventListener('click', function() {
    storeResponse('no', 6);  // 6 oznacza, że jest to odpowiedź na szóste pytanie
});
